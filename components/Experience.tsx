...
const jobs: Job[] = [
  {
    ...
    details: [
      ...
      },
      {
        title: "流程优化",
        items: [
          "实践IPD项目管理流程，结合SAFe敏捷方法",
          "设计并落地自工序完结机制，规范项目立项、迭代、测试与交付全流程",
        ],
      },
      {
        title: "质量管理",
        items: [
          "主导质量管理流程优化，推动详细设计自工序落地",
          "加强研发过程质量管控，获得BG质量之星奖",
        ],
      },
    ],
  },
